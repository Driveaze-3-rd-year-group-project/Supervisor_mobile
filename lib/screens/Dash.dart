            ...
            children: [
              ...
              Container(
                ...
                child: PageView(
                  ...
                  children: [
                    _buildAnnouncementCard('System Maintenance Notice', 'Due to scheduled maintenance, our services will be unavailable on 20/08/2024 from 9 AM to 12 PM.'),
              ...
              GridView.count(
                ...
                children: [
                  _buildSummaryCard('Repairing', '4', Color(0xFF01103B)),
                  _buildSummaryCard('Completed', '5', Color(0xFF01103B)),
                  _buildSummaryCard('Inventory item', '10', Color(0xFF01103B)),
                  _buildSummaryCard('Technicians', '3', Color(0xFF01103B)),
                ],
              ),
              SizedBox(height: 40),
